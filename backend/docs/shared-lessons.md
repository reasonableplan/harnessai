...
**근거**: workout-app /ha-review: 9 BLOCK 전부 FP (logs/routines store test 의 DROP TABLE 2건 + testSqliteDb.ts 의 .exec 7건). 프로덕션 client.ts 는 drizzle/expo-sqlite API 만 사용. v0.19.3 `d934ee6` 에서 구현 완료(promote 2026-07-06).
